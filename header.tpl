...
{if $templatefile == 'homepage'}<div class="cloud-bg"></div>{/if}
<section id="header">
    <div class="container container">
        ...
        {else}
            <a href="{$WEB_ROOT}/index.php" class="navbar-brand"><img src="{{assetPath file='logo.svg'}|replace:'/svg/':'/images/'}" alt="{$companyname}"></a>
        {/if}
    </div>
</section>
                    ...
                    <div class="main-slider">
                            ...
                            <div class="row rtl-row">
                                <div class="col-sm-5">
                                    <div class="img-holder">
                                        <img src="{{assetPath file='slide-img1.png'}|replace:'/png/':'/images/'}" alt="">
                                    </div>
                                </div>
                                <div class="col-sm-7">
                        ...
                        <div class="slide">
                            <div class="row rtl-row">
                                <div class="col-sm-5">
                                    <div class="img-holder">
                                        <img src="{{assetPath file='slide-img2.png'}|replace:'/png/':'/images/'}" alt="">
                                    </div>
                                </div>
                                <div class="col-sm-7">
                        ...
                        <div class="slide">
                            <div class="row rtl-row">
                                <div class="col-sm-5">
                                    <div class="img-holder">
                                        <img src="{{assetPath file='slide-img3.png'}|replace:'/png/':'/images/'}" alt="">
                                    </div>
                                </div>
                                <div class="col-sm-7">
